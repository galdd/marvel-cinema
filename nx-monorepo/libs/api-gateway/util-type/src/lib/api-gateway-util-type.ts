...
export type IsTypeOfResolverFn<T = any, TContext = any> = (
  obj: T,
  context: TContext,
  info: GraphQLResolveInfo,
...
> = {
  createOrder?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateOrderArgs, 'ticketId'>
  >;
  createShow?: Resolver<
    ResolversTypes['Show'],
    ParentType,
    ...
    RequireFields<
      ...
      'dateAndTIme' | 'moviedbApiId' | 'price' | 'ticketAmount'
    >
  >;
  editShow?: Resolver<
    ResolversTypes['Show'],
    ...
    ContextType,
    RequireFields<
      MutationEditShowArgs,
      'dateAndTIme' | 'moviedbApiId' | 'price' | 'ticketAmount'
    >
  >;
  removeOrder?: Resolver<
    Array<ResolversTypes['String']>,
    ParentType,
    ContextType,
    RequireFields<MutationRemoveOrderArgs, 'id'>
  >;
  removeShow?: Resolver<
    ResolversTypes['String'],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveShowArgs, 'id'>
  >;
  removeUser?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  signin?: Resolver<
    ResolversTypes['UserSession'],
    ParentType,
    ContextType,
  ...
  updateUser?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateUserArgs, 'email' | 'isAdmin'>
  >;
};
...
> = {
  ...
  Tickets?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryTicketsArgs, 'showId'>
  >;
...
> = {
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  moviedbApiId?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  isSoldOut?: Resolver<
